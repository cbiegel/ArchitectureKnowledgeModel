 ...
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.ArchitectureKnowledgeModelImpl#getConceptualSolutions <em>Conceptual Solutions</em>}</li>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.ArchitectureKnowledgeModelImpl#getDevelopmentEnvironments <em>Development Environments</em>}</li>
...
public class ArchitectureKnowledgeModelImpl extends ArchitectureKnowledgeModelBaseImpl implements ArchitectureKnowledgeModel {
	...
	public NotificationChain basicSetConceptualSolutions(ConceptualSolutions newConceptualSolutions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL__CONCEPTUAL_SOLUTIONS, oldConceptualSolutions, newConceptualSolutions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConceptualSolutions(ConceptualSolutions newConceptualSolutions) {
		if (newConceptualSolutions != conceptualSolutions) {
			...
			if (conceptualSolutions != null)
				msgs = ((InternalEObject)conceptualSolutions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL__CONCEPTUAL_SOLUTIONS, null, msgs);
			if (newConceptualSolutions != null)
				msgs = ((InternalEObject)newConceptualSolutions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL__CONCEPTUAL_SOLUTIONS, null, msgs);
			msgs = basicSetConceptualSolutions(newConceptualSolutions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL__CONCEPTUAL_SOLUTIONS, newConceptualSolutions, newConceptualSolutions));
	}
	...
	public NotificationChain basicSetDevelopmentEnvironments(DevelopmentEnvironments newDevelopmentEnvironments, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL__DEVELOPMENT_ENVIRONMENTS, oldDevelopmentEnvironments, newDevelopmentEnvironments);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDevelopmentEnvironments(DevelopmentEnvironments newDevelopmentEnvironments) {
		if (newDevelopmentEnvironments != developmentEnvironments) {
			...
			if (developmentEnvironments != null)
				msgs = ((InternalEObject)developmentEnvironments).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL__DEVELOPMENT_ENVIRONMENTS, null, msgs);
			if (newDevelopmentEnvironments != null)
				msgs = ((InternalEObject)newDevelopmentEnvironments).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL__DEVELOPMENT_ENVIRONMENTS, null, msgs);
			msgs = basicSetDevelopmentEnvironments(newDevelopmentEnvironments, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL__DEVELOPMENT_ENVIRONMENTS, newDevelopmentEnvironments, newDevelopmentEnvironments));
	}
