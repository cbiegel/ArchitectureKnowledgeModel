 ...
 * @version 1.0
 */
public class GSSQueryResultModelElementFormPage extends AbstractGSSFormPage {
	 ...
	 */
	public GSSQueryResultModelElementFormPage(FormEditor editor, String id, String title,
