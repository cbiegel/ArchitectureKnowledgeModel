...
/**
 * A Figure for GSS Element. Contains can contain figures for decorating the button and top of the figure
 * 
...
public class ElementFigure extends Figure {
	 ...
	 * the constructor
	 * 
	 * @param bodyDecoratorFigure  the AbstractDecoratorFigure for the body
	 * @param footDecoratorFigure the Figure for the decoration of the bottom
...
//	  System.out.println("ElementFigure.paintFigure");
	 ...
	 * @param c the Color used to Highlight the node
	 */
