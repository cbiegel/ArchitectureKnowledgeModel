...
/**
 * A Figure for the name and importance (local priority) of an Element. The Figure contains an icon and observer for expanding and collapsing the node as well.
 * 
...
public class NameFigure extends Figure {
	 ...
	 * 
	 * @param font the font used to draw the name
	 * @param name the caption for the name of the element
	 * @param isExpandable node has incoming connections and could be expanded or collapsed
	 */
	public NameFigure(Font font, String name, boolean isExpandable) {
	 ...
	 * @param name the caption for the name of the element
	 * @param isExpandable node has incoming connections and could be expanded or collapsed
	 * @param importance the (GRL) importance of the element; equals the priority of GSS
	 */
	public NameFigure(Font font, String name, boolean isExpandable, Float importance ) {
		super();
	 ...
	 * 
	 * @param expandText a String or char to show the node is collapsed or expanded
	 */
	private void setExpandFigureText(String expandText) {
	 ...
	 * @param expanded the node it expanded or not 
	 */
	private void notifyExpandListener(boolean expanded) {
		try {
