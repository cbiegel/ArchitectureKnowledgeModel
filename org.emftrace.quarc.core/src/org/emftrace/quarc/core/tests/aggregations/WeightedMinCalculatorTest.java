...
public class WeightedMinCalculatorTest extends QUARCCoreTestCase{
	...
	public void test() {
		...
		assertEquals(40.0f , new WeightedMinCalculator(goalList, cacheManager).calcAggregation(si1));
	}
