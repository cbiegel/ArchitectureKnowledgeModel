...
/**
 * calculated the maximal of the weighted impacts for a specified solution
 * 
 * @author Daniel Motschmann
 * @version 1.0
 */
public class WeightedMaxCalculator extends AbstractCalculator {
	 ...
	 */
	public WeightedMaxCalculator(List<Element> goals, CacheManager cacheManager) {
	...
	public float calcAggregation(ConstrainedElement constrainedElement) {
		...
		for (Object element : goals){
			...
			result = Math.max(result, finalRating);
		}
