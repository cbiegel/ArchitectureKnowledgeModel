...
/**
 * calculated the maximal impact for the specified solution
 * 
 * @author Daniel Motschmann
 * @version 1.0
 */
public class MaxCalculator extends AbstractCalculator {
	 ...
	 */
	public MaxCalculator(List<Element> goals, CacheManager cacheManager) {
