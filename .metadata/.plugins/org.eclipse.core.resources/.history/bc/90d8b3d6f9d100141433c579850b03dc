 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.ASTAImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.ASTAImpl#getCondition <em>Condition</em>}</li>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.ASTAImpl#getCapabilityType <em>Capability Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ASTAImpl extends ArchitectureKnowledgeModelBaseImpl implements ASTA {
	/**
	...
	protected EClass eStaticClass() {
		return ArchitectureKnowledgeModelPackage.Literals.ASTA;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.ASTA__DESCRIPTION, oldDescription, description));
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.ASTA__CONDITION, oldCondition, condition));
	}
	...
	public void setCapabilityType(CapabilityType newCapabilityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.ASTA__CAPABILITY_TYPE, oldCapabilityType, capabilityType));
	}
