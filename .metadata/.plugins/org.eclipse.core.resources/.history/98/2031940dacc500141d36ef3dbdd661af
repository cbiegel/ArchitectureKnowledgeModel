 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.RelationsImpl#getRelations <em>Relations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationsImpl extends ArchitectureKnowledgeModelBaseImpl implements Relations {
	...
	public EList<Relation> getRelations() {
		if (relations == null) {
			relations = new EObjectResolvingEList<Relation>(Relation.class, this, ArchitectureKnowledgeModelPackage.RELATIONS__RELATIONS);
		}
		return relations;
	}
