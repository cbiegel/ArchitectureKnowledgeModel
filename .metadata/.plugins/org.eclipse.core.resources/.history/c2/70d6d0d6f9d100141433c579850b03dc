/**
 */
package org.emftrace.metamodel.ArchitectureKnowledgeModel.TechnologySolutionCatalogPackage.impl;
...
import org.emftrace.metamodel.ArchitectureKnowledgeModel.TechnologySolutionCatalogPackage.TechnologySolutionCatalogPackage;
...
public class TechnologySolutionCatalogPackagePackageImpl extends EPackageImpl implements TechnologySolutionCatalogPackagePackage {
	 ...
	 * @see org.emftrace.metamodel.ArchitectureKnowledgeModel.TechnologySolutionCatalogPackage.TechnologySolutionCatalogPackagePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getTechnologySolutionCatalogPackage_RelationCatalog() {
	 ...
	 * @generated
	 */
	public EReference getTechnologySolutionCatalogPackage_ConceptualSolutionCatalog() {
		return (EReference)technologySolutionCatalogPackageEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getTechnologySolutionCatalogPackage_DevelopmentEnvironmentCatalog() {
		return (EReference)technologySolutionCatalogPackageEClass.getEStructuralFeatures().get(5);
	}
	...
	public void createPackageContents() {
		...
		createEReference(technologySolutionCatalogPackageEClass, TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__RELATION_CATALOG);
		createEReference(technologySolutionCatalogPackageEClass, TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__CONCEPTUAL_SOLUTION_CATALOG);
		createEReference(technologySolutionCatalogPackageEClass, TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__DEVELOPMENT_ENVIRONMENT_CATALOG);
	}
	...
	public void initializePackageContents() {
		...
		ArchitectureKnowledgeModelPackage theArchitectureKnowledgeModelPackage = (ArchitectureKnowledgeModelPackage)EPackage.Registry.INSTANCE.getEPackage(ArchitectureKnowledgeModelPackage.eNS_URI);
		...
		initEReference(getTechnologySolutionCatalogPackage_TechnologySolutionCatalog(), theArchitectureKnowledgeModelPackage.getTechnologySolutionCatalog(), null, "TechnologySolutionCatalog", null, 1, 1, TechnologySolutionCatalogPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTechnologySolutionCatalogPackage_TechnologyFeatureCatalog(), theArchitectureKnowledgeModelPackage.getTechnologyFeatureCatalog(), null, "TechnologyFeatureCatalog", null, 1, 1, TechnologySolutionCatalogPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTechnologySolutionCatalogPackage_ASTACatalog(), theArchitectureKnowledgeModelPackage.getASTACatalog(), null, "ASTACatalog", null, 1, 1, TechnologySolutionCatalogPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTechnologySolutionCatalogPackage_RelationCatalog(), theArchitectureKnowledgeModelPackage.getRelationCatalog(), null, "RelationCatalog", null, 1, 1, TechnologySolutionCatalogPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTechnologySolutionCatalogPackage_ConceptualSolutionCatalog(), theArchitectureKnowledgeModelPackage.getConceptualSolutionCatalog(), null, "ConceptualSolutionCatalog", null, 1, 1, TechnologySolutionCatalogPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTechnologySolutionCatalogPackage_DevelopmentEnvironmentCatalog(), theArchitectureKnowledgeModelPackage.getDevelopmentEnvironmentCatalog(), null, "DevelopmentEnvironmentCatalog", null, 1, 1, TechnologySolutionCatalogPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
