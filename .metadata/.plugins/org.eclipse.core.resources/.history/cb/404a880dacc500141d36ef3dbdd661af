 ...
 * @generated
 */
public class ArchitectureKnowledgeModelSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ArchitectureKnowledgeModelSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL_BASE: {
				ArchitectureKnowledgeModelBase architectureKnowledgeModelBase = (ArchitectureKnowledgeModelBase)theEObject;
				T result = caseArchitectureKnowledgeModelBase(architectureKnowledgeModelBase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.ARCHITECTURE_KNOWLEDGE_MODEL: {
				ArchitectureKnowledgeModel architectureKnowledgeModel = (ArchitectureKnowledgeModel)theEObject;
				T result = caseArchitectureKnowledgeModel(architectureKnowledgeModel);
				if (result == null) result = caseArchitectureKnowledgeModelBase(architectureKnowledgeModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.TECHNOLOGY_SOLUTION_CATALOG: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(technologySolutionCatalog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.TECHNOLOGY_FEATURE_CATALOG: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(technologyFeatureCatalog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.RELATION_CATALOG: {
				RelationCatalog relationCatalog = (RelationCatalog)theEObject;
				T result = caseRelationCatalog(relationCatalog);
				if (result == null) result = caseArchitectureKnowledgeModelBase(relationCatalog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.ASTA_CATALOG: {
				ASTACatalog astaCatalog = (ASTACatalog)theEObject;
				T result = caseASTACatalog(astaCatalog);
				if (result == null) result = caseArchitectureKnowledgeModelBase(astaCatalog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.CONCEPTUAL_SOLUTION_CATALOG: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(conceptualSolutionCatalog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.DEVELOPMENT_ENVIRONMENT_CATALOG: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(developmentEnvironmentCatalog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.TECHNOLOGY_SOLUTIONS: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(technologySolutions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.TECHNOLOGY_SOLUTION: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(technologySolution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.TECHNOLOGY_FEATURE: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(technologyFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.ASTA: {
				ASTA asta = (ASTA)theEObject;
				T result = caseASTA(asta);
				if (result == null) result = caseArchitectureKnowledgeModelBase(asta);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.BENEFIT: {
				Benefit benefit = (Benefit)theEObject;
				T result = caseBenefit(benefit);
				if (result == null) result = caseASTA(benefit);
				if (result == null) result = caseArchitectureKnowledgeModelBase(benefit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.FEATURE_BASED_BENEFIT: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(featureBasedBenefit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.CONCERN_BASED_BENEFIT: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(concernBasedBenefit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.DRAWBACK: {
				Drawback drawback = (Drawback)theEObject;
				T result = caseDrawback(drawback);
				if (result == null) result = caseASTA(drawback);
				if (result == null) result = caseArchitectureKnowledgeModelBase(drawback);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.FEATURE_BASED_DRAWBACK: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(featureBasedDrawback);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.CONCERN_BASED_DRAWBACK: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(concernBasedDrawback);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.CONCEPTUAL_SOLUTIONS: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(conceptualSolutions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.CONCEPTUAL_SOLUTION: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(conceptualSolution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.DEVELOPMENT_ENVIRONMENTS: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(developmentEnvironments);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.DEVELOPMENT_ENVIRONMENT: {
				...
				if (result == null) result = caseArchitectureKnowledgeModelBase(developmentEnvironment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.RELATIONS: {
				Relations relations = (Relations)theEObject;
				T result = caseRelations(relations);
				if (result == null) result = caseArchitectureKnowledgeModelBase(relations);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.RELATION: {
				Relation relation = (Relation)theEObject;
				T result = caseRelation(relation);
				if (result == null) result = caseArchitectureKnowledgeModelBase(relation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.RELATION_SOURCE_TYPE: {
				RelationSourceType relationSourceType = (RelationSourceType)theEObject;
				T result = caseRelationSourceType(relationSourceType);
				if (result == null) result = caseArchitectureKnowledgeModelBase(relationSourceType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArchitectureKnowledgeModelPackage.RELATION_TARGET_TYPE: {
				RelationTargetType relationTargetType = (RelationTargetType)theEObject;
				T result = caseRelationTargetType(relationTargetType);
				if (result == null) result = caseArchitectureKnowledgeModelBase(relationTargetType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseArchitectureKnowledgeModelBase(ArchitectureKnowledgeModelBase object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Architecture Knowledge Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Architecture Knowledge Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArchitectureKnowledgeModel(ArchitectureKnowledgeModel object) {
		return null;
	}
...
} //ArchitectureKnowledgeModelSwitch
