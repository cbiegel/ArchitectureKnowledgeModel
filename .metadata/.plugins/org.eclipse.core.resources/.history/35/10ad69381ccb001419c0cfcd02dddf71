...
public class ConnectionDecoratorService {
	...
	public static void decoradeConnection(final GraphConnection pConnection,
		...
		// TODO CB: Andere Figuren ausprobieren? (Siehe GSS-Klasse)
		// decorateWithMakeFigure(pConnection);

		// TODO CB: ChangeListener implementieren? (Für das SourceElement, wenn z.B. im
		// TechnologySolution-Element ein Feature hinzugefügt oder entfernt wird
