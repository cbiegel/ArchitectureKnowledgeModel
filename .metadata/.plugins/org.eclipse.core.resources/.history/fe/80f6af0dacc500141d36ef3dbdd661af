 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.DevelopmentEnvironmentCatalogImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.DevelopmentEnvironmentCatalogImpl#getDevelopmentEnvironment <em>Development Environment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DevelopmentEnvironmentCatalogImpl extends ArchitectureKnowledgeModelBaseImpl implements DevelopmentEnvironmentCatalog {
	/**
	...
	protected EClass eStaticClass() {
		return ArchitectureKnowledgeModelPackage.Literals.DEVELOPMENT_ENVIRONMENT_CATALOG;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.DEVELOPMENT_ENVIRONMENT_CATALOG__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<DevelopmentEnvironment> getDevelopmentEnvironment() {
		if (developmentEnvironment == null) {
			developmentEnvironment = new EObjectContainmentEList<DevelopmentEnvironment>(DevelopmentEnvironment.class, this, ArchitectureKnowledgeModelPackage.DEVELOPMENT_ENVIRONMENT_CATALOG__DEVELOPMENT_ENVIRONMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ArchitectureKnowledgeModelPackage.DEVELOPMENT_ENVIRONMENT_CATALOG__DEVELOPMENT_ENVIRONMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArchitectureKnowledgeModelPackage.DEVELOPMENT_ENVIRONMENT_CATALOG__DESCRIPTION:
