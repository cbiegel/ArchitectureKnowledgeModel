/**
 */
package org.emftrace.metamodel.ArchitectureKnowledgeModel.TechnologySolutionCatalogPackage.provider;
...
/**
 * This is the item provider adapter for a {@link org.emftrace.metamodel.ArchitectureKnowledgeModel.TechnologySolutionCatalogPackage.TechnologySolutionCatalogPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TechnologySolutionCatalogPackageItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TechnologySolutionCatalogPackagePackage.Literals.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__RELATION_CATALOG);
			childrenFeatures.add(TechnologySolutionCatalogPackagePackage.Literals.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__CONCEPTUAL_SOLUTION_CATALOG);
			childrenFeatures.add(TechnologySolutionCatalogPackagePackage.Literals.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__DEVELOPMENT_ENVIRONMENT_CATALOG);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TechnologySolutionCatalogPackage.class)) {
			...
			case TechnologySolutionCatalogPackagePackage.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__RELATION_CATALOG:
			case TechnologySolutionCatalogPackagePackage.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__CONCEPTUAL_SOLUTION_CATALOG:
			case TechnologySolutionCatalogPackagePackage.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__DEVELOPMENT_ENVIRONMENT_CATALOG:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TechnologySolutionCatalogPackagePackage.Literals.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__RELATION_CATALOG,
				 ArchitectureKnowledgeModelFactory.eINSTANCE.createRelationCatalog()));

		newChildDescriptors.add
			(createChildParameter
				(TechnologySolutionCatalogPackagePackage.Literals.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__CONCEPTUAL_SOLUTION_CATALOG,
				 ArchitectureKnowledgeModelFactory.eINSTANCE.createConceptualSolutionCatalog()));

		newChildDescriptors.add
			(createChildParameter
				(TechnologySolutionCatalogPackagePackage.Literals.TECHNOLOGY_SOLUTION_CATALOG_PACKAGE__DEVELOPMENT_ENVIRONMENT_CATALOG,
