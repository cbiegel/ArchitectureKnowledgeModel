 ...
 * <ul>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.TechnologySolutionCatalogImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.emftrace.metamodel.ArchitectureKnowledgeModel.impl.TechnologySolutionCatalogImpl#getTechnologySolution <em>Technology Solution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TechnologySolutionCatalogImpl extends ArchitectureKnowledgeModelBaseImpl implements TechnologySolutionCatalog {
	/**
	...
	protected EClass eStaticClass() {
		return ArchitectureKnowledgeModelPackage.Literals.TECHNOLOGY_SOLUTION_CATALOG;
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitectureKnowledgeModelPackage.TECHNOLOGY_SOLUTION_CATALOG__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<TechnologySolution> getTechnologySolution() {
		if (technologySolution == null) {
			technologySolution = new EObjectContainmentEList<TechnologySolution>(TechnologySolution.class, this, ArchitectureKnowledgeModelPackage.TECHNOLOGY_SOLUTION_CATALOG__TECHNOLOGY_SOLUTION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ArchitectureKnowledgeModelPackage.TECHNOLOGY_SOLUTION_CATALOG__TECHNOLOGY_SOLUTION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArchitectureKnowledgeModelPackage.TECHNOLOGY_SOLUTION_CATALOG__DESCRIPTION:
